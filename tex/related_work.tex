...
\begin{table}
    ...
    \begin{tabular}{lll} % TODO  Value Range shoulb be replaced by data type
        \toprule
        Index & Feature                       & Value Range                                                  \\ \midrule
        ...
        8     & is in ring                    & true, false                                                  \\ \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}
    ...
    \begin{tabular}{lll}
        ...
        2     & is conjugated & true, false                            \\\bottomrule
    \end{tabular}
