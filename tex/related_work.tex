...
See \autoref{fig:model-graphormer}

\begin{figure}
    \centering
    \includegraphics[scale=0.2]{tex/res/graphormer_fig.png}
    \caption{Graphormer model architecture \tiny{source: \cite{2021graphormer}}}
    \label{fig:model-graphormer}
\end{figure}
