...
The other two encodings are added as bias to the Attention Module used in Transformers as seen in \autoref{fig:graphormer_att} and the following equation.
\begin{equation}
